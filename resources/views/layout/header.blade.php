<header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-4 text-center">
            <a class="blog-header-logo text-dark" href="#">Homework Laravel</a>
        </div>
        <div class="col-4 d-flex justify-content-end align-items-center">
            ...
            @guest
                ...
                @endif
            @else
                    <a id="navbarDropdown" class="btn btn-sm btn-outline-secondary" href="{{ route('logout') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
